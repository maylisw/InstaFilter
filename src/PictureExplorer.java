...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
    ...
    private void setUpNextAndPreviousButtons()
    {
        ...
        Icon prevIcon = new ImageIcon(DigitalPicture.class.getResource("imagesrc/leftArrow.gif"),
                "previous index");
        Icon nextIcon = new ImageIcon(DigitalPicture.class.getResource("imagesrc/rightArrow.gif"),
                "next index");
